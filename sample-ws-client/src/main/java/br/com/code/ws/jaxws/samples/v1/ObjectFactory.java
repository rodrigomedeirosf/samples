 ...
 * generated in the br.com.code.ws.jaxws.samples.v1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://ws.code.com.br/jaxws/samples/v1", "add");
    private final static QName _AddResponse_QNAME = new QName("http://ws.code.com.br/jaxws/samples/v1", "addResponse");
    private final static QName _Divide_QNAME = new QName("http://ws.code.com.br/jaxws/samples/v1", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://ws.code.com.br/jaxws/samples/v1", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://ws.code.com.br/jaxws/samples/v1", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("http://ws.code.com.br/jaxws/samples/v1", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://ws.code.com.br/jaxws/samples/v1", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://ws.code.com.br/jaxws/samples/v1", "subtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.code.ws.jaxws.samples.v1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.com.br/jaxws/samples/v1", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.com.br/jaxws/samples/v1", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.com.br/jaxws/samples/v1", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.com.br/jaxws/samples/v1", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.com.br/jaxws/samples/v1", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.com.br/jaxws/samples/v1", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.com.br/jaxws/samples/v1", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.code.com.br/jaxws/samples/v1", name = "subtractResponse")
